...
const AppsPath = '/usr/local/lib/launcher';
const AppsPaths = [ AppsPath ];

const IndicatorName = 'QLauncher';
...
const QuickLaunch = new Lang.Class({
    ...
    _init: function(metadata, params) {
        ...
        this._icon = new St.Icon({ icon_name: 'open-menu-symbolic', style_class: 'system-status-icon' });
